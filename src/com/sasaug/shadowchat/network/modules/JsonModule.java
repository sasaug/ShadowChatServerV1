...
public class JsonModule extends ANetwork implements IModule{

	public String getModuleId() {return NetworkCore.ID + ".JsonModule";}

	public Type getReceiveType() {return Type.JSON;}
	...
	public boolean onReceive(TCPClient client, byte[] data) throws Exception{	
		...
		JsonMessage.Builder builder = JsonMessage.newBuilder(msg);
		builder.setTimestamp(System.currentTimeMillis());
		JsonMessage response = builder.build();
