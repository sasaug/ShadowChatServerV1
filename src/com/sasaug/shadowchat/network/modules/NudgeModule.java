...
public class NudgeModule extends ANetwork implements IModule{

	public String getModuleId() {return NetworkCore.ID + ".NudgeModule";}

	public Type getReceiveType() {return Type.NUDGE;}
	...
	public boolean onReceive(TCPClient client, byte[] data) throws Exception{	
		...
		baseBuilder.setType(Type.NUDGE);
		...
		if(msg.hasGroup()){
			...
			ArrayList<String> temp = DB.getStringArray("Group", "getMembers", groupId);
		...
		NudgeMessage.Builder builder = NudgeMessage.newBuilder(msg);
		builder.setTimestamp(System.currentTimeMillis());
		NudgeMessage response = builder.build();
